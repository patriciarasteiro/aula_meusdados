...
# Legend
my_title <- "Busco: Resultado Grupo Externo-Endopterygota"
...
my_species <- c('Anopheles_gambiae', 'Anopheles_gambiae', 'Anopheles_gambiae', 'Anopheles_gambiae', 'Drosophila_melanogaster', 'Drosophila_melanogaster', 'Drosophila_melanogaster', 'Drosophila_melanogaster', 'Tribolium_castaneum', 'Tribolium_castaneum', 'Tribolium_castaneum', 'Tribolium_castaneum', 'Ctenocephalides_felis', 'Ctenocephalides_felis', 'Ctenocephalides_felis', 'Ctenocephalides_felis')
...
my_percentage <- c(95.9, 1.6, 0.7, 1.8, 98.7, 1.1, 0.0, 0.2, 98.6, 0.6, 0.2, 0.6, 59.4, 35.3, 1.0, 4.3)
my_values <- c(2036, 34, 14, 40, 2096, 24, 0, 4, 2095, 13, 4, 12, 1261, 749, 21, 93)
...
ggsave(file = "3_grupoexterno.png", width = my_width, height = my_height, units = "cm", dpi = 300)
print("Done")
